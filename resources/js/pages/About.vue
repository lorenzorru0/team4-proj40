...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="about col-12">
            <h2 class="title text-uppercase font-weight-bold">Deliveboo è una piattaforma che accontenta ogni tua richiesta</h2> 
        </div>
        <h3 class="about col-12">Fai visita ai nostri Partner</h3>
    </div> 
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 d-flex flex-column align-items-center justify-content-around">  
                <div class="founder">
                    <img src="https://storage.ecodibergamo.it/media/photologue/2017/11/16/photos/cache/deliveroo-sbarca-in-bici-a-bergamoi-piatti-dei-migliori-ristoranti-a-domi_ec14610a-ca94-11e7-9af1-e8c55fce35d3_700_455_big_gallery_linked_i.jpg" alt="Deliveboo Rider">
                </div>
                <div class="founder">
                    <img src="https://images.squarespace-cdn.com/content/v1/545c89e5e4b039195ee53e4a/1563031324762-1ZULRWG9UXU5V7NSS0ZI/consumer.png?format=1000w" alt="Deliveboo App">
                </div>     
            </div>     
        </div>
    </div> 
