                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="business_name" class="col-md-3 col-form-label text-md-right">{{ __('Business name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="street_number" class="col-md-3 col-form-label text-md-right">{{ __('Street number') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="vat_number" class="col-md-3 col-form-label text-md-right">{{ __('Vat number') }}</label>
